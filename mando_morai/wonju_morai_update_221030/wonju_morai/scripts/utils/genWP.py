...
DISTANCE_WP2WP_STRAIGHT=5 # init=0.8
DISTANCE_WP2WP_CURVE=2 # init=0.3
plot_switch=0

# 1st WP

#load_data=np.loadtxt('/home/jungj/catkin_ws/src/velodyne_pkg/scripts/utils/wonju_path_1.csv',delimiter=',',dtype=str) # Input GPS csv file
load_data=np.loadtxt('./utils/wonju_path1.csv',delimiter=',',dtype=str) # Input GPS csv file
...
load_data_2=np.loadtxt('./utils/wonju_path2.csv',delimiter=',',dtype=str) # Input GPS csv file
...
load_data_3=np.loadtxt('./utils/wonju_path3.csv',delimiter=',',dtype=str) # Input GPS csv file
...
print("length of WP_1",len(WP_X_1))
print("length of WP_2",len(WP_X_2))
print("length of WP_3",len(WP_X_3))
...
if plot_switch==1:
    ...
    plt.scatter(WP_X_1,WP_Y_1,s=12,c='red')
    plt.scatter(longitude,latitude,s=1,c='black')
    plt.scatter(WP_X_2,WP_Y_2,s=12,c='blue')
    plt.scatter(longitude,latitude,s=1,c='green')
    plt.grid()
    plt.show()
