...
class Maneuver:
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            if self.clustering_message and self.odom_status and self.mission_status and self.lane_camera_status: # if self.clustering_message and self.odom_status and self.mission_status:
                print 'OK'
                break
            else:
    ...
    def main(self):      
        ...
        while not rospy.is_shutdown():
            ...
            if self.mission_status==11: # 
                ...
                #print 'steering(lane) : ',desired_steer
