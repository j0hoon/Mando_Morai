...
from maneuver_planner_msg.msg import maneuver_planner_msg, Mission, Wp_index
...
class Control:
    ...
    def __init__(self):
        ...
        self.wp_index_pub = rospy.Publisher('/wp_index',Wp_index,queue_size=1)
    ...
    def main(self):
        ...
        while not rospy.is_shutdown():
            ...
            elif driving_mode == 2: #decceleration
            ...
            self.wp_index_pub.publish(WP_index)
