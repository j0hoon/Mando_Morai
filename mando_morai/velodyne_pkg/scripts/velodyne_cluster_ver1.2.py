...
class SCANCluster:
    ...
    def pointcloud2_to_xyz(self, cloud_msg):
        ...
        for point in pc2.read_points(cloud_msg, skip_nans=True):
            ...
            if point[2] > -1.3 and dist < 11 and angle>-20/180*np.pi and angle<20/180*np.pi: # init=50 , if point[0] > 0 and point[2] > -1.3 and dist < 25 and angle>-30/180*np.pi and angle<30/180*np.pi:
