...
from utils.genWP import WP_X_1, WP_Y_1
...
class Control:
    ...
    def __init__(self):
        ...
        self.swg = SWG_make(WP_X_1, WP_Y_1)
        ...
        self.init_signal=1
        self.old_WP_index = 0
        self.velo_status = None
        self.odom_status = None
        while True:
            if self.velo_status and self.odom_status:
                break
    ...
    def velo_callback(self,msg):
        ...
        self.velo_status = msg

    def sub_velo_status(self,msg):
    ...
    def main(self):
        ...
        while not rospy.is_shutdown():
            ...
            WP_index=self.swg.WAYPOINT_INITIALIZING(WP_X_1,WP_Y_1,x_ego,y_ego)
            if (old_WP_index!=WP_index or min_index>50 or init_signal==1):
                WP_x,WP_y=self.swg.trajectory_make(WP_X_1,WP_Y_1,WP_index,x_ego,y_ego,ego_head)
                init_signal=0
                TG_signal=1
            else:
                TG_signal=0

            self.ctrl_msg.steering,min_index = pure_pursuit(WP_x, WP_y, ego_status_vel_x, x_ego,y_ego,ego_head) # ego_status_vel_x, ego_status_vel_y
            ...
            print 'accel : ',self.control_input
