...
load_data=np.loadtxt('./utils/wonju_path_1.csv',delimiter=',',dtype=str) # Input GPS csv file
...
load_data_2=np.loadtxt('./utils/wonju_path_2.csv',delimiter=',',dtype=str) # Input GPS csv file
...
load_data_3=np.loadtxt('./utils/wonju_path_3.csv',delimiter=',',dtype=str) # Input GPS csv file
...
plt.scatter(WP_X_1,WP_Y_1,s=8,c='red')
